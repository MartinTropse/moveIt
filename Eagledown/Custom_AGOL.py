...
# Sources
# Uploads a temp GDB to AGOL and downloads it locally and then deletes it.
# https://community.esri.com/t5/arcgis-api-for-python-questions/download-feature-service-as-file-geodatabase/td-p/837620
# https://community.esri.com/t5/python-questions/python-download-feature-service-from-agol-to/td-p/1080465

# points to this esri documentation
